...
function SignupForm() {
    ...
    async function onSubmit(values) {
        setIsLoading(true);
        if (!("TURBOPACK compile-time value", "AIzaSyA_...replace_this..._U") || ("TURBOPACK compile-time value", "AIzaSyA_...replace_this..._U").includes('YOUR_')) {
            toast({
                variant: "destructive",
                title: 'Firebase Not Configured',
                description: 'Please add your Firebase credentials to the .env file to enable sign up.'
            });
            setIsLoading(false);
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e87bf92._.js.map